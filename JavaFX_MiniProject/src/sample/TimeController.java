...
public class TimeController  implements Initializable {
    ...
    public Connection getConnection(){
        ...
        try{
            ...
            Connection conn = DriverManager.getConnection("jdbc:mysql://remotemysql.com:3306/KpP3S6N6BH", "KpP3S6N6BH", "3B4zr7DAdJ");
            return conn;
        }catch (Exception e){
    ...
    public Countries getSelectedCountry(ActionEvent actionEvent){
    ...
    public void countryChanged1(ActionEvent actionEvent) {
    ...
    //Country selection 2
    public void countryChanged2(ActionEvent actionEvent) {
        Countries country = getSelectedCountry(actionEvent);
        System.out.println(country);
        if (flag2)
            clock2.stop();
